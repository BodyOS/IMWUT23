...
__nv int E_remaining = 0;
__nv int targetEnergy;
__nv int Vs = 33; // Boosted Voltage
__nv int I_msp = 100; // uA
__nv int P_in = 1000;  //uW
__nv int exe_time_coff =2510;  // ~132 ms
__nv int charging_time_coff;   // ~328 ms
__nv int charging_time_coff_arr[10];
__nv bool PF_flag;
__nv int PF_number = 0;
__nv int PF_number_arr [10];
void Reset() {
//   PF_number++;
    PMMCTL0 = 0x0008;
}
