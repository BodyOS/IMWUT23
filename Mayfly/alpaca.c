 ...
 */
#pragma PERSISTENT(curctx)
context_t * volatile curctx = &context_0;
/**
 * @brief current version which updates at every reboot or transition
 */
#pragma PERSISTENT(_numBoots)
...
void task_prologue()
{
    ...
    pathIDCount = __pathIDCount;
    pathLayerCounter = __pathLayerCounter;
