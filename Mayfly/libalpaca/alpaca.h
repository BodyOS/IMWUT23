...
extern int pathIDCount;
extern int pathLayerCounter;
...
task_t TASK_SYM_NAME(func) = { func, idx };    \
...
#define MAYFLY_ENTRY \
    void _entry_task(); \
    TASK(0, _entry_task) \
void _entry_task() { MAYFLY_TRANSITION; }
...
#define MAYFLY_TRANSITION mayfly_transition()
#endif // ALPACA_H
